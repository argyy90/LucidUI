...
local function BuildProfilerWindow()
  ...
  profilerWin:SetBackdrop({bgFile=NS.TEX_WHITE, edgeFile=NS.TEX_WHITE, edgeSize=1})
  ...
  closeBtn:SetText("X")
  closeBtn:GetFontString():SetFont(NS.FONT, 11, "OUTLINE")
  ...
  memHeader:SetFont(NS.FONT, 10, "OUTLINE")
  ...
  cpuHeader:SetFont(NS.FONT, 10, "OUTLINE")
